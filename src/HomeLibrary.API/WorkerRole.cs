...
namespace HomeLibrary.API
{
    public class WorkerRole : RoleEntryPoint
    {
        ...
        private readonly MicroService microService = null;
        ...
        public WorkerRole()
        {
            var connectionString = CloudConfigurationManager.GetSetting("SQL.Database.ConnectionString");
            microService = new MicroService(new ServiceSettings())
                .WithStartupTask(() => new DbMigrator(connectionString));
        }
